0x0F. Python - Object-relational mapping
    ...
    Ongoing project - started 08-05-2021, must end by 08-09-2021 (in 3 days) - you're done with 0% of tasks.
...
General
    ...
    All your functions (inside and outside a class) should have a documentation (python -c 'print(__import__("my_module").my_function.__doc__)' and python3 -c 'print(__import__("my_module").MyClass.my_function.__doc__)')
